 ...
 *
 * Edited to revert back to .update() API vs overriding .updateMatrixWorld()
 * Setting visibility in .updateMatrixWorld() made it impossible to implement the OutlinePass.
 */
...
THREE.TransformControls = function ( camera, domElement ) {
	...
	// update updates key transformation variables
...
THREE.TransformControlsGizmo = function () {
	...
	// update will update transformations and appearance of individual handles
